...
class Save extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Natxo\Moduloback\Model\Index');
            ...
            if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
				try {
                        ...
                        $config = $this->_objectManager->get('Natxo\Moduloback\Model\Config');
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('Nuevo item guardado.'));
